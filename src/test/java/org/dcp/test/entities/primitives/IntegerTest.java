...
public class IntegerTest {
    ...
    public void testBasicFunctionality() {
        ...
        try {
            final Integer integerMaybeParsable = new Integer(java.lang.Long.MIN_VALUE, Constants.BITS_IN_A_INTEGER);
            assertTrue(false);
        } catch(IllegalArgumentException ie) {
            //Good!
        }

        final Integer integerParsableMin = new Integer(java.lang.Long.MIN_VALUE + 1, Constants.BITS_IN_A_INTEGER);
        assertEquals(integerParsableMin.value(), java.lang.Long.MIN_VALUE + 1);

        final Integer integerParsableMax = new Integer(java.lang.Long.MAX_VALUE, Constants.BITS_IN_A_INTEGER);
    ...
    public void testReadFunctionality() {
        ...
        assertEquals(new Integer(17).readFrom(new MockBitInputStream("01111111111111111")).value(), 65535);
        ...
        assertEquals(new Integer(17).readFrom(new MockBitInputStream("11111111111111111")).value(), -65535);
    }
