...
public class EntropyUtilTest {
    ...
    public void testFindSizeOfBitsToHold() {
        ...
        assertEquals(EntropyUtil.findSizeOfBitsToHoldBig(new BigInteger("-115792089237316195423570985008687907853269984665640564039457584007913129639935")), 257);
        assertEquals(EntropyUtil.findSizeOfBitsToHoldBig(new BigInteger("")), 1024);
    }
    ...
    public void findMaximumValueRepresentible() {
        ...
        assertEquals(EntropyUtil.findMaximumValueRepresentibleBig(63), new BigInteger("9223372036854775807"));
        assertEquals(EntropyUtil.findMaximumValueRepresentibleBig(64), new BigInteger("18446744073709551615"));
        assertEquals(EntropyUtil.findMaximumValueRepresentibleBig(128), new BigInteger("340282366920938463463374607431768211455"));
        assertEquals(EntropyUtil.findMaximumValueRepresentibleBig(256), new BigInteger("115792089237316195423570985008687907853269984665640564039457584007913129639935"));
        assertEquals(EntropyUtil.findMaximumValueRepresentibleBig(1024), new BigInteger(""));
    }
